 ...
 * Especificação: docs/FUNCIONALIDADES-NEGOCIO.md §10.2
 *
 * Como implementar:
 ...
 */
test.describe('Fluxo 10.2 — parcelas-automaticas', () => {
  test.fixme('TODO: implementar fluxo 10.2', async ({ page, tenant }) => {
