 ...
 * Especificação: docs/FUNCIONALIDADES-NEGOCIO.md §10.6
 *
 * Como implementar:
 ...
 */
test.describe('Fluxo 10.6 — pendencias-financeiras', () => {
  test.fixme('TODO: implementar fluxo 10.6', async ({ page, tenant }) => {
