 ...
 * Especificação: docs/FUNCIONALIDADES-NEGOCIO.md §9.1
 *
 * Como implementar:
 ...
 */
test.describe('Fluxo 9.1 — biblioteca-de-clausulas', () => {
  test.fixme('TODO: implementar fluxo 9.1', async ({ page, tenant }) => {
